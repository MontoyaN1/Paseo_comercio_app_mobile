...
abstract class ImagenBase extends Equatable {
  ...
  String get tamañoFormateado {
    if (tamañoBytes < 1024) {
      return '${tamañoBytes} B';
    } else if (tamañoBytes < 1024 * 1024) {
      return '${(tamañoBytes / 1024).toStringAsFixed(1)} KB';
    } else {
      return '${(tamañoBytes / (1024 * 1024)).toStringAsFixed(1)} MB';
    }
  }
...
class ImagenTienda extends ImagenBase {
  ...
  ImagenTienda copyWith({
    ...
    return ImagenTienda(
      ...
      tamañoBytes: tamañoBytes ?? this.tamañoBytes,
