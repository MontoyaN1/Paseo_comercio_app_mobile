// lib/presentation/widgets/organizacion/organizacion_bg_painter.dart
//
// 🏛️ FONDO: Partículas isométricas flotantes (branding)
// ────────────────────────────────────────────────────────────
// El fondo es transparente - el color de fondo viene del tema.
// Los efectos decorativos (partículas, isométricos) se adaptan al tema.
// ────────────────────────────────────────────────────────────
...
class OrganizacionBgPainter extends CustomPainter {
  final double t;
  final Brightness brightness;

  OrganizacionBgPainter(this.t, this.brightness);
  ...
  @override
  bool shouldRepaint(OrganizacionBgPainter o) =>
